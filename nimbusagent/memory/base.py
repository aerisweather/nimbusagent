...
class AgentMemory:
    ...
    def _trim_excess_entries(self):
        ...
        """
        while (self.num_tokens > self.max_tokens) or (len(self.chat_history) > self.max_messages):
    ...
    def resize(
        self, max_tokens_resize: Optional[int] = None, max_messages_resize: Optional[int] = None
    ):
        """
